...
#define OKL4_USER_AREA_END ((okl4_laddr_t)(1099511627776U))
...
/**
    ...
    - @ref OKL4_PAGE_CACHE_WRITEBACK_NOALLOC
...
#define OKL4_PAGE_CACHE_DEFAULT ((okl4_page_cache_t)0x0U)
/*lint -esym(621, OKL4_PAGE_CACHE_IPC_RX) */
#define OKL4_PAGE_CACHE_IPC_RX ((okl4_page_cache_t)0x0U)
/*lint -esym(621, OKL4_PAGE_CACHE_TRACEBUFFER) */
#define OKL4_PAGE_CACHE_TRACEBUFFER ((okl4_page_cache_t)0x0U)
/*lint -esym(621, OKL4_PAGE_CACHE_WRITEBACK) */
#define OKL4_PAGE_CACHE_WRITEBACK ((okl4_page_cache_t)0x0U)
/*lint -esym(621, OKL4_PAGE_CACHE_DEVICE) */
#define OKL4_PAGE_CACHE_DEVICE ((okl4_page_cache_t)0x1U)
/*lint -esym(621, OKL4_PAGE_CACHE_IPC_TX) */
#define OKL4_PAGE_CACHE_IPC_TX ((okl4_page_cache_t)0x2U)
/*lint -esym(621, OKL4_PAGE_CACHE_STRONG) */
#define OKL4_PAGE_CACHE_STRONG ((okl4_page_cache_t)0x3U)
/*lint -esym(621, OKL4_PAGE_CACHE_WRITEBACK_NOALLOC) */
#define OKL4_PAGE_CACHE_WRITEBACK_NOALLOC ((okl4_page_cache_t)0x4U)
/*lint -esym(621, OKL4_PAGE_CACHE_WRITECOMBINE) */
#define OKL4_PAGE_CACHE_WRITECOMBINE ((okl4_page_cache_t)0x5U)
/*lint -esym(621, OKL4_PAGE_CACHE_WRITETHROUGH) */
#define OKL4_PAGE_CACHE_WRITETHROUGH ((okl4_page_cache_t)0x6U)
...
okl4_page_cache_is_element_of(okl4_page_cache_t var)
{
    /*lint --e{944} Disable dead expression detection */
    /*lint --e{948} --e{845} Disable constant always zero */
    return ((var == OKL4_PAGE_CACHE_DEFAULT) ||
            ...
            (var == OKL4_PAGE_CACHE_WRITEBACK_NOALLOC) ||
            (var == OKL4_PAGE_CACHE_WRITECOMBINE) ||
...
/**
    ...
    - @ref OKL4_ERROR_LAST_CPU
    - @ref OKL4_ERROR_CPU_ALREADY_OFFLINE
    - @ref OKL4_ERROR_CPU_ALREADY_ONLINE
...
/**
    The operation failed because the caller is on the last
    online cpu.
*/
/*lint -esym(621, OKL4_ERROR_LAST_CPU) */
#define OKL4_ERROR_LAST_CPU ((okl4_error_t)0x27U)
/**
    The operation failed because the specified physical CPU
    is already offline.
*/
/*lint -esym(621, OKL4_ERROR_CPU_ALREADY_OFFLINE) */
#define OKL4_ERROR_CPU_ALREADY_OFFLINE ((okl4_error_t)0x28U)
/**
    The operation failed because the specified physical CPU
    is already online.
*/
/*lint -esym(621, OKL4_ERROR_CPU_ALREADY_ONLINE) */
#define OKL4_ERROR_CPU_ALREADY_ONLINE ((okl4_error_t)0x29U)
/**
...
okl4_error_is_element_of(okl4_error_t var)
{
    ...
    return ((var == OKL4_ERROR_ALREADY_STARTED) ||
            ...
            (var == OKL4_ERROR_CPU_ALREADY_OFFLINE) ||
            (var == OKL4_ERROR_CPU_ALREADY_ONLINE) ||
...
/*lint -esym(621, OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_ADD) */
#define OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_ADD ((okl4_tracepoint_evt_t)0x43U)
/*lint -esym(621, OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_REMOVE) */
#define OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_REMOVE ((okl4_tracepoint_evt_t)0x44U)
/*lint -esym(621, OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_GET_ONLINE_CPUS) */
#define OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_GET_ONLINE_CPUS ((okl4_tracepoint_evt_t)0x45U)
/*lint -esym(621, OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_SUSPEND) */
#define OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_SUSPEND ((okl4_tracepoint_evt_t)0x46U)
...
okl4_tracepoint_evt_is_element_of(okl4_tracepoint_evt_t var)
{
    ...
    return ((var == OKL4_TRACEPOINT_EVT_SCH_SCHEDULER_FLAG_SET_RUNNABLE) ||
            ...
            (var == OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_ADD) ||
            (var == OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_REMOVE) ||
            (var == OKL4_TRACEPOINT_EVT_SWI_SCHEDULER_GET_ONLINE_CPUS) ||
...
struct _okl4_sys_scheduler_cpu_add_return {
    okl4_error_t error;
};

struct _okl4_sys_scheduler_cpu_remove_return {
    okl4_error_t error;
};

struct _okl4_sys_scheduler_get_online_cpus_return {
    okl4_error_t error;
    okl4_register_t cpu_bitmap;
};
 ...
 **/
/*lint -esym(621, OKL4_USER_AREA_END) */
#define OKL4_USER_AREA_END (1099511627776)
...
#define OKL4_ASM_PAGE_CACHE_DEFAULT (0x0)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_IPC_RX) */
#define OKL4_ASM_PAGE_CACHE_IPC_RX (0x0)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_TRACEBUFFER) */
#define OKL4_ASM_PAGE_CACHE_TRACEBUFFER (0x0)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_WRITEBACK) */
#define OKL4_ASM_PAGE_CACHE_WRITEBACK (0x0)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_DEVICE) */
#define OKL4_ASM_PAGE_CACHE_DEVICE (0x1)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_IPC_TX) */
#define OKL4_ASM_PAGE_CACHE_IPC_TX (0x2)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_STRONG) */
#define OKL4_ASM_PAGE_CACHE_STRONG (0x3)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_WRITEBACK_NOALLOC) */
#define OKL4_ASM_PAGE_CACHE_WRITEBACK_NOALLOC (0x4)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_WRITECOMBINE) */
#define OKL4_ASM_PAGE_CACHE_WRITECOMBINE (0x5)
/*lint -esym(621, OKL4_ASM_PAGE_CACHE_WRITETHROUGH) */
#define OKL4_ASM_PAGE_CACHE_WRITETHROUGH (0x6)
...
/**
    ...
    online cpu.
*/
/*lint -esym(621, OKL4_ASM_ERROR_LAST_CPU) */
#define OKL4_ASM_ERROR_LAST_CPU (0x27)
/**
    The operation failed because the specified physical CPU
    is already offline.
*/
/*lint -esym(621, OKL4_ASM_ERROR_CPU_ALREADY_OFFLINE) */
#define OKL4_ASM_ERROR_CPU_ALREADY_OFFLINE (0x28)
/**
    The operation failed because the specified physical CPU
    is already online.
*/
/*lint -esym(621, OKL4_ASM_ERROR_CPU_ALREADY_ONLINE) */
#define OKL4_ASM_ERROR_CPU_ALREADY_ONLINE (0x29)
/**
    KSP specific error 0
*/
...
/*lint -esym(621, OKL4_ASM_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_ADD) */
#define OKL4_ASM_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_ADD (0x43)
/*lint -esym(621, OKL4_ASM_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_REMOVE) */
#define OKL4_ASM_TRACEPOINT_EVT_SWI_SCHEDULER_CPU_REMOVE (0x44)
/*lint -esym(621, OKL4_ASM_TRACEPOINT_EVT_SWI_SCHEDULER_GET_ONLINE_CPUS) */
#define OKL4_ASM_TRACEPOINT_EVT_SWI_SCHEDULER_GET_ONLINE_CPUS (0x45)
/*lint -esym(621, OKL4_ASM_TRACEPOINT_EVT_SWI_SCHEDULER_SUSPEND) */
#define OKL4_ASM_TRACEPOINT_EVT_SWI_SCHEDULER_SUSPEND (0x46)
