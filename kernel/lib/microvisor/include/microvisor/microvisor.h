 ...
 * common data types such as Weaved environment definitions used by
 * applications as well as other OKL4 libraries.
 *
 */
...
#include <okl4_environment/static.h>
#include <okl4_environment/accessor.h>
